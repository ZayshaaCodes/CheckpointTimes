...
void Main(){
    ...
    _panels.InsertLast(DebuggingUiPanel());
...
void Render(){
    for (uint i = 0; i < _panels.Length; i++) _panels[i].Render();
}
...
//         {
//             auto ctz = curTimes[i] == 0;
//             auto btz = bestTimes[i] == 0;
//             if(!ctz) cl++;
//             if(!btz) bl++;
//             if(btz && ctz) break;
//         }
